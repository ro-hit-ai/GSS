...
try {
    ...
    $sql =
        ...
        . "    WHEN COALESCE(NULLIF(TRIM(c.workflow_mode), ''), 'validator_first') = 'verifier_first' AND vv.status IS NOT NULL THEN 'verifier'\n"
        ...
        . "    WHEN COALESCE(NULLIF(TRIM(c.workflow_mode), ''), 'validator_first') = 'verifier_first' AND vv.status IS NOT NULL THEN 'pending'\n"
