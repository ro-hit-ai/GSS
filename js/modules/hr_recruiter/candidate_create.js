(function () {
    ...
    async function loadClientLocations() {
        ...
        try {
            ...
            var url = base + '/api/hr_recruiter/client_locations_list.php';
    ...
    async function loadJobRoles() {
        ...
        try {
            var base = (window.APP_BASE_URL || '').replace(/\/$/, '');
            var url = base + '/api/hr_recruiter/job_roles_list.php';
    ...
    async function saveCandidate() {
        ...
        try {
            var base = (window.APP_BASE_URL || '').replace(/\/$/, '');
            var createUrl = base + '/api/hr_recruiter/create_case.php';
