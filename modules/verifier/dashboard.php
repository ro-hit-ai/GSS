...
<style>
    ...
    .vr-panel-h{display:flex; align-items:flex-start; justify-content:space-between; gap:10px; flex-wrap:wrap;}
...
<div class="card vr-card qa-like-main">
    <div class="qa-like-head">
        <div>
            ...
            <div class="qa-like-subtitle">Current verifier queue, assigned modules, and quick actions.</div>
        </div>
    ...
    <div class="vr-actions">
        ...
        <button type="button" class="vr-btn vr-btn-soft" id="refreshDashboard">Refresh</button>
    </div>
        ...
        <div class="vr-panel-b">
            <div class="vr-mini">
                <div class="vr-mini-card">
                    ...
                    <div class="d">Use the start buttons for your assigned modules or open Candidate List to pick a case.</div>
                </div>
                <div class="vr-mini-card">
                    <div class="h">Portal workflow</div>
                    <div class="d">Verifier now opens the same embedded candidate portal layout used by validator.</div>
                </div>
                <div class="vr-mini-card">
                    <div class="h">QA readiness</div>
                    <div class="d">Complete remarks and evidence carefully before sending a component forward.</div>
                </div>
            </div>
        </div>
    </div>
