...
<div class="card" style="display:flex; justify-content:space-between; align-items:center; gap:10px; flex-wrap:wrap;">
    <div>
        <h3 style="margin:0;">Verifier Dashboard</h3>
        <p class="card-subtitle" style="margin:2px 0 0 0;">QA-style layout with verifier workflow actions.</p>
    </div>
</div>
...
<div class="card qa-like-main">
    <div class="qa-like-head">
        <div>
            ...
            <div class="qa-like-subtitle">Current verifier queue, my tasks, and quick actions.</div>
        </div>
    ...
    <div class="vr-actions">
        <button type="button" class="vr-btn vr-btn-primary" id="vrStartBasicBtn">Start BASIC Verify</button>
        <button type="button" class="vr-btn vr-btn-soft" id="vrStartEducationBtn">Start EDUCATION Verify</button>
        <a class="vr-btn vr-btn-primary" href="candidates_list.php">Open Candidate List</a>
        <button id="refreshDashboard" class="vr-btn vr-btn-soft" type="button">Refresh</button>
    </div>
